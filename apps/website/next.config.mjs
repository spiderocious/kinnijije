...
const nextConfig = {
  ...
  transpilePackages: ['@kinnijije/ui', '@kinnijije/core'],
  webpack: (config) => {
    config.resolve.alias = {
      ...(config.resolve.alias ?? {}),
      '@kinnijije/ui': path.resolve(__dirname, '../../packages/ui/src/index.ts'),
      '@kinnijije/core': path.resolve(__dirname, '../../packages/core/src/index.ts'),
